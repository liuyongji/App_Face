...
/**
 * 图片处理界面 Created by sky on 2015/7/8. Weibo: http://weibo.com/2030683111 Email:
 * 1132234509@qq.com
 */
...
//		ButterKnife.inject(this);
		...
		ImageUtils.asyncLoadImage(this, getIntent().getData(),
		...
		ImageUtils.asyncLoadSmallImage(this, getIntent().getData(),
				new ImageUtils.LoadImageCallback() {
					@Override
					public void callback(Bitmap result) {
	...
	private void initView() {
		...
		ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(App.getApp()
				.getScreenWidth(), App.getApp().getScreenWidth());
		...
		// 初始化推荐标签栏
		commonLabelArea = LayoutInflater.from(PhotoProcessActivity.this)
				.inflate(R.layout.view_label_bottom, null);
	...
	private void initEvent() {
		...
		labelSelector.setTxtClicked(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				EditTextActivity.openTextEdit(PhotoProcessActivity.this, "", 8,
	...
	private void savePicture() {
		// 加滤镜
		final Bitmap newBitmap = Bitmap.createBitmap(mImageView.getWidth(),
				mImageView.getHeight(), Bitmap.Config.ARGB_8888);
		Canvas cv = new Canvas(newBitmap);
		RectF dst = new RectF(0, 0, mImageView.getWidth(),
...
//			CameraManager.getInst().close();
	...
	private boolean setCurrentBtn(TextView btn) {
		if (currentBtn == null) {
			...
			currentBtn.setCompoundDrawablesWithIntrinsicBounds(null, null,
					null, null);
		}
	...
	private void initStickerToolBar() {
		...
		bottomToolBar.setAdapter(new StickerToolAdapter(
				PhotoProcessActivity.this, EffectUtil.addonList));
		bottomToolBar
				.setOnItemClickListener(new it.sephiroth.android.library.widget.AdapterView.OnItemClickListener() {
					...
					public void onItemClick(
						...
						EffectUtil.addStickerImage(mImageView,
								PhotoProcessActivity.this, sticker,
	...
	private void initFilterToolBar() {
		final List<FilterEffect> filters = EffectService.getInst()
				.getLocalFilters();
		final FilterAdapter adapter = new FilterAdapter(
				PhotoProcessActivity.this, filters, smallImageBackgroud);
					...
					public void onItemClick(
						...
						if (adapter.getSelectFilter() != arg2) {
							...
							GPUImageFilter filter = GPUImageFilterTools
									.createFilterForType(
											PhotoProcessActivity.this, filters
													.get(arg2).getType());
							mGPUImageView.setFilter(filter);
							GPUImageFilterTools.FilterAdjuster mFilterAdjuster = new GPUImageFilterTools.FilterAdjuster(
									filter);
							// 可调节颜色的滤镜
