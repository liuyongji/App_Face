...
public class Result extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ShareContent="我正在使用一个很有趣的人脸检测应用，我的颜值相似度达到"+s_result+"果然是天生丽质呢，你也来测试一下看看吧"+url;
		initshare();
	}
	private void initview() {
		...
		result1.setImageBitmap(MainActivity.curBitmap[0]);
		result2.setImageBitmap(MainActivity.curBitmap[1]);
	...
	private void initshare() {
		...
		//微信
		UMWXHandler wxHandler = new UMWXHandler(Result.this,"wxd0792b8632aa595b");
		wxHandler.addToSocialSDK();
		
		UMWXHandler wxCircleHandler = new UMWXHandler(Result.this,"wxd0792b8632aa595b");
		...
		//腾讯
		UMQQSsoHandler qqSsoHandler = new UMQQSsoHandler(Result.this, "1101987894",
                "McgaoeK2xHK8T0qm");
		qqSsoHandler.addToSocialSDK();
		QZoneSsoHandler qZoneSsoHandler = new QZoneSsoHandler(Result.this, "1101987894",
                "McgaoeK2xHK8T0qm");
	...
	public void onClick(View v) {
        ...
        case R.id.button2:
        	...
        	umsharecontorl.takeScrShot(Result.this, umAppAdapter, onScreenshotListener);
